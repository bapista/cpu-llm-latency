...
fast lanes. The router is pure-heuristic and unit-tested. \note{Add a short
pseudocode listing of \texttt{\_classify\_lane} + the hot-affinity
arbitration.}
...
\FILL{add 2--3 more: adaptive computation / early-exit, LLM-as-judge cost,
